...
(global-set-key (kbd "C-c n p m") (lambda () (interactive) (shell-command "npm version minor && npm publish &")))
(global-set-key (kbd "C-c n p M") (lambda () (interactive) (shell-command "npm version major && npm publish &")))
