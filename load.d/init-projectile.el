...
(defhydra hydra-projectile (:color magenta
  ...
  ("d" projectile-find-dir                                        "" :color blue)
  ("D" projectile-dired                                           "")
  ("e" projectile-recentf                                         "")
  ("E" projectile-edit-dir-locals                                 "")
  ("f" projectile-find-file                                       "Display a list of all files in the project.")
  ...
  ("x t" projectile-run-term                                      "" :color teal)
  ("x s" projectile-run-shell                                     ""  :color teal)
