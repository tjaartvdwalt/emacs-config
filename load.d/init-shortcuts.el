...
"
  ...
  ("m" hydra-multiple-cursors/body :exit t :color teal)
  ("n" hydra-navigate/body :exit t :color teal)
  ("o" hydra-origami/body :exit t :color teal)
  ("p" hydra-projectile/body :exit t :color teal)
  ("s" hydra-smerge/body :exit t :color teal)
  ("v" magit-status :exit t)
  ("w" hydra-web-mode/body :exit t :color teal)
  ("z" hydra-zoom/body :exit t :color teal))
